...
class SpentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spent" do
    assert_difference('Spent.count') do
      post spents_url, params: { spent: { category: @spent.category, description: @spent.description, value: @spent.value } }
    end
  ...
  test "should update spent" do
    patch spent_url(@spent), params: { spent: { category: @spent.category, description: @spent.description, value: @spent.value } }
